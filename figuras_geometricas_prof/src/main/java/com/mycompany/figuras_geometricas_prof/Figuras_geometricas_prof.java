...
public class Figuras_geometricas_prof {
...
/*    
    public static void main(String[] args) {
       ...
       Punto p1_1 = new Punto(10,20);
       Punto p1_2 = new Punto(10,30);
       
       Recta r1 = new Recta(p1_1,p1_2);
       
       Recta r2 = new Recta(new Punto(10,20), new Punto(10,30));
       
        System.out.println("La recta r2 tiene las coordenada "+r2.getP1().getX() + ", " + r2.getP1().getY() + 
